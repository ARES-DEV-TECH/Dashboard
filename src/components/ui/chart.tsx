...
type TooltipContentProps = React.ComponentProps<"div"> & {
  active?: boolean
  payload?: Array<{ name?: string; dataKey?: string; value?: unknown; payload?: unknown; color?: string; type?: string }>
  label?: string
...
type LegendPayloadItem = { type?: string; dataKey?: string; value?: string; color?: string }
